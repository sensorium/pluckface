...
/** \file
   ...
   Pitch detection using a fast onset_ptronic comb filter

   This pitch extraction method implements a fast onset_ptronic comb filter to
   determine the fundamental frequency of a onset_ptronic sound.
